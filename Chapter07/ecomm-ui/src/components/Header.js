      ...
      <nav className="bg-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div id="headerUserMenu" className="hidden md:block">
        ...
        <div
          className={
            open || openMobileMenu ? "block md:hidden" : "hidden md:hidden"
          }
        >
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <button
              ...
              className="hidden md:block text-gray-300 hover:bg-gray-700 hover:text-white  px-3 py-2 rounded-md text-base font-medium"
            >
              Cart
            </button>
            <button
